...
class Config
{
    ...
    function __construct()
    {
        ...
        $this->comment .= " * GitHub: https://github.com/ThePMDuo" . PHP_EOL;
        $this->comment .= " * Discord: https://discord.gg/KD4Fp8dnZD" . PHP_EOL;
        $this->comment .= " * Reddit: https://www.reddit.com/user/ThePMDuo" . PHP_EOL;
        $this->comment .= " */" . PHP_EOL;
