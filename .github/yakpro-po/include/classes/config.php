...
class Config
{
    ...
    //      ex: ['Exception', 'PDO', 'PDOStatement', 'PDOException'];
    ...
    function __construct()
    {
        ...
        $this->comment .= " * ██║░╚═╝░██║██║░░██║╚██████╔╝██║╚█████╔╝╚██████╔╝██║░░██║██║░╚═╝░██║███████╗██████╔╝" . PHP_EOL;
        $this->comment .= " * ╚═╝░░░░░╚═╝╚═╝░░╚═╝░╚═════╝░╚═╝░╚════╝░░╚═════╝░╚═╝░░╚═╝╚═╝░░░░░╚═╝╚══════╝╚═════╝░" . PHP_EOL;
        $this->comment .= " * Auto Generated on: " . date('d F Y, h:i:s A') . " - " . date_default_timezone_get() . PHP_EOL;
        $this->comment .= " * " . PHP_EOL;
        $this->comment .= " *    Copyright 2022 MagicGames" . PHP_EOL;
        $this->comment .= " *    Licensed under the Apache License, Version 2.0 (the 'License');" . PHP_EOL;
        $this->comment .= " *    you may not use this file except in compliance with the License." . PHP_EOL;
        $this->comment .= " *    You may obtain a copy of the License at" . PHP_EOL;
        $this->comment .= " * " . PHP_EOL;
        $this->comment .= " *        http://www.apache.org/licenses/LICENSE-2.0" . PHP_EOL;
        $this->comment .= " * " . PHP_EOL;
        $this->comment .= " *    Unless required by applicable law or agreed to in writing, software" . PHP_EOL;
        $this->comment .= " *    distributed under the License is distributed on an 'AS IS' BASIS," . PHP_EOL;
        $this->comment .= " *    WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied." . PHP_EOL;
