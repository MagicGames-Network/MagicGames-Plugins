...
class Main extends PluginBase implements Listener
{
    ...
    public function onEnable(): void
    {
        ...
        if ($this->config->get("Check Rank Expiry every 60 seconds") === true) {
            $this->getScheduler()->scheduleRepeatingTask(new CheckTask($this), 20 * 60 * 60 * 6);
        }
    }
                    ...
                    if (isset($args[0])) {
                        if ($args[0] === "set") {
                            ...
                            if ($group !== null) {
                                ...
                                $time2 = $this->parseTimeFormat($args[3]);
                                if (!is_int($time2) || !is_int($time1)) {
                                    return false;
                                }
                                $endtime = date("Y-m-d H:i:s", $time1 + $time2);
    ...
    public function getTimeLeft(string $playername): ?string
    {
    ...
    public function getExpiryDate(string $playername): ?string
    {
    ...
    public function getOldGroup(string $playername): ?string
    {
    ...
    public function removeRank(string $playername): void
    {
        /** @var PurePerms */
        $pp = $this->getServer()->getPluginManager()->getPlugin("PurePerms");
    ...
    public function parseSecondToHuman(int $seconds): ?string
    {
        $dt1 = new \DateTime("@0");
